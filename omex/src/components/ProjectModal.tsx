...
export const ProjectModal = ({ closing }: ProjectModalProps) => {
	return (
		<dialog
			open
			className="border-1 border-gray-200 self-center border-black p-4 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white shadow-lg z-30"
		>
			<form method="dialog">
