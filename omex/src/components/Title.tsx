export const Title = ({ text, id }: { text: string; id: string }) => {
	const style = {
		background:
			'repeating-linear-gradient(45deg, #fafafaff 0px, #90bad3ff 1px, transparent 1px, transparent 6px)',
	};
	const style2 = {
		background:
			'repeating-linear-gradient(45deg, #fafafaff 0px, #90bad3ff 1px, transparent 1px, transparent 3px)',
	};
	return (
