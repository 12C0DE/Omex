        ...
        <Dialog
            ...
            <div className="fixed inset-0 flex w-screen items-center justify-center p-4">
                ...
                >
                    ...
                    <form className="flex flex-col gap-4 mt-8 w-full font-kanit tracking-wide text-xl max-w-lg" onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className="flex flex-col gap-2 mx-4 md:mx-0">
                            ...
                            <div className="flex flex-row justify-end mt-4 gap-2">
                                <Button className="px-4 py-2 hover:bg-gray-500" onClick={closing}>
                                    Cancel
                                </Button>
